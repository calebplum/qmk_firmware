...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_ESC, KC_TAB, KC_LGUI,  KC_LSFT, KC_BSPC,  MT(MOD_LCTL, KC_DEL), MT(MOD_LALT, KC_TAB), KC_SPC,  MO(_RS), KC_MINS, KC_BSLS, KC_ENT ),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    TD(TD_LSEL), KC_INS,  KC_LGUI, KC_LSFT, KC_DEL,  MT(MOD_LCTL, KC_DEL), MT(MOD_LALT, KC_TAB), KC_SPC,  KC_TRNS, KC_0, KC_DOT, KC_PGDN ),
